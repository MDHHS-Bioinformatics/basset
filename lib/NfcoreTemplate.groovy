...
class NfcoreTemplate {
    ...
    public static String logo(workflow, monochrome_logs) {
        ...
        String.format(
            ...
            ${colors.bired}  ____         _____  _____    _______              ${colors.reset}
            ${colors.bired} |  _ \\       / ____|/ ____|  |__   __|             ${colors.reset}
            ${colors.bired} | |_) | __ _| (___ | (___   ___ | |                 ${colors.reset}
            ${colors.bired} |  _ < / _` |\\___ \\ \\___ \\/  _ \\| |            ${colors.reset}
            ${colors.bired} | |_) | (_| |____) |____) | ___/| |                 ${colors.reset}
            ${colors.bired} |____/ \\__,_|_____/|_____/\\____||_|               ${colors.reset}
