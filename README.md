...
|----------------------------------|----------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|---------------------------------------------|---------------------------------------------|---------------------------------------------|
| _Acinetobacter baumannii_         | [`Kaptive`](https://github.com/klebgenomics/Kaptive)                  | Serotyping based on K and OC antigens                                                           | -                                           | -                                           | ✔️     |
...
| _Legionella pneumophila_          | [`ABRicate`](https://github.com/tseemann/abricate)                    | O‑antigen serogrouping (_wzm/wzt_)                                                                  | -                                           | -                                           | ✔️     |
...
| _Vibrio parahaemolyticus_         | [`Kaptive`](https://github.com/klebgenomics/Kaptive)                 | K/O serotyping                                                                                   | -                                           | -                                           | ✔️     |
| _Vibrio cholerae_                 | [`ARIBA`](https://github.com/sanger-pathogens/ariba)                  | Detect _ctxA, ctxB, tcpA, rstR_                                                                    | ✔️     | ✔️     | -                                           |
| _Vibrio cholerae_                 | [`Kaptive`](https://github.com/klebgenomics/Kaptive)                 | O‑antigen serotyping                                                                             | -                                           | -                                           | ✔️     |
